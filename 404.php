...
<body>
  ...
  <div class="text">
    <h1>404 Error</h1>
    <h3>CHúng tôi không thể tìm thấy trang của bạn đang tìm :(</h3>
    <h4>Hãy trở lại <a href="index.php" class="btn btn-light"> <i class="fas fa-arrow-left">Trang chủ</i></a></h4>
  </div>
</body>
                                ...
                                <table class="table table-hover table-secondary ">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo SITEURL;?>admin/admin-delete-qld.php?Student_UserID=<?php echo $row['Student_UserID'];?>&Subject=<?php echo $row['Subject'];?>"><button type="button" class="btn btn-danger" ><i class="fas fa-trash-alt "></i></button></a></td>
